package com.mohamedzamel.movies.shared.utils.ui.progressiveLayouts;
...
public class ProgressConstraintLayout extends ConstraintLayout implements ProgressLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        loadingStateProgressBarColor =
                typedArray.getColor(R.styleable.ProgressActivity_loadingProgressBarColor, Color.parseColor("#0076BF"));
